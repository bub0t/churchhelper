...
[
	{ "id": "t1", "title": "God\'s Faithfulness in Difficulty", "description": "These provided verses speak to people facing real need, uncertainty, or struggle, while pointing them back to God\'s steady character and care. Theologically, the theme highlights that God remains trustworthy and present even when circumstances are painful or unclear. Taken together, the verses show that hope is rooted in who God is, not merely in immediate outcomes. For the congregation today, this invites honest discussion about where people need endurance, comfort, and renewed trust in God.", "covers": [0,1] },
	{ "id": "t2", "title": "Receiving Grace", "description": "The first provided verse speaks into the human experience of failure, need, or unworthiness by revealing God\'s gracious initiative toward people. Theologically, it underscores that grace begins with God\'s character and action rather than human effort or deserving. The verse itself invites hearers to respond with humility, gratitude, and trust. For a congregation today, this theme can help people reflect on where they need to receive God\'s grace more deeply and extend that same grace to others.", "covers": [0] },
	{ "id": "t3", "title": "Renewed Hope", "description": "The second provided verse speaks to people who may be weary, uncertain, or tempted to lose heart, offering a reason to continue trusting God. Theologically, it shows that hope is sustained by God\'s faithfulness and not by changing circumstances alone. The verse itself encourages perseverance and a forward-looking confidence grounded in God\'s promises. For the congregation today, this theme creates space to talk about waiting well, encouraging one another, and holding on to hope in difficult seasons.", "covers": [1] }
]
